package com.example.productmicroservice.dto.product.get;
...
/**
 * Data Transfer Object (DTO) for retrieving products.
 * This class represents the response payload for retrieving products.
 */
@Setter
@Getter
@Builder
